...
(function() {
	...
	// Buttons: navLink.
		$('#navLink > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				showMobileMenu();
			}
		...
		$('#navLink > li:nth-child(3) > a').addEventListener(
			'click',
			function(event) { 
				showMobileMenu();
			}
		...
		$('#navLink > li:nth-child(4) > a').addEventListener(
			'click',
			function(event) { 
				showMobileMenu();
			}
	...
	// Initialize "On Visible" animations.
		onvisible.add('#desktopTopNav > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#topNav > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, replay: false });
